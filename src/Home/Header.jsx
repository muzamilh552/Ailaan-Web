...
const Header = () => {
    ...
    return (
        <div className='flex flex-row justify-center items-center mt-7 gap-19 max-sm:flex-col max-sm:gap-7'>
            <a href=""><img className='logo ' src={logo} alt="" /></a>

            <ul className=' relative flex flex-row  items-center max-sm:flex-col  '>
                <li className='flex flex-row items-center max-sm:justify-center max-sm:items-center'><button className='flex justify-center items-center gap-3 h-[6vh] bg-[#2BBEF9] text-[#FFFFFF] font-normal rounded-3xl w-[13vw] max-sm:w-[40vw] max-sm:ml-22 max-sm:text-xs max-sm:gap-1'><span ><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </span></button> <span><input className='search max-sm:w-20' type="search" placeholder='Find Cars, Mobile Phones and more...' />
                ...
                <li className='flex gap-3 max-sm:mt-6 max-sm:ml-[20%]'>
                    <button className='text-[white] bg-[black] rounded-2xl w-16 h-8 ' onClick={() => {
                        navigate("/login")
                    }}>Login</button>

                    <button className='text-white bg-[#2BBEF9] rounded-2xl w-16 flex gap-1 justify-center items-center '><span><svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
