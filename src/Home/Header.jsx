        ...
        <div className='header'>
          <a href=""><img className='logo' src={logo} alt="" /></a>  
            ...
            <ul className='leftHeader'>
                <li><button className='text'><span ><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </span> Rahim Yar Khan <span className='vect'><svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
