...
const Footer = () => {
    ...
    return (
        <>
            <div className='flex flex-row bg-[#141821] w-full justify-evenly items-start max-sm:flex-col max-sm:justify-center max-sm:items-center max-sm:text-xs max-sm:gap-3'>

                <ul className='flex gap-2 flex-col max-sm:justify-center max-sm:items-center'>
            ...
            <div className="flex bg-[#141821] flex-col justify-center items-center text-[white] py-4 border-t border-b-gray-400 w-full ">
