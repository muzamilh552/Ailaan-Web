...
const MobileDetails = () => {
    ...
    return (
        <>
            <div className='flex flex-row gap-4 justify-around mt-26 ml-16 max-sm:ml-[22%] max-sm:flex-col-reverse max-sm:justify-center max-sm:mt-10'>

                <img className='w-171.5 h-131 max-sm:w-[90%] max-sm:h-auto' src={singlePhone?.product_display_image} alt="" />
                <div className='flex flex-col justify-center items-start gap-6'>
                    ...
                    <div className="flex flex-row justify-between items-center gap-57 max-sm:gap-18">
                    ...
                    <div className="flex flex-col gap-4 border-2-[#D8DFE0]">
                        <button className='bg-[#2BBEF9] w-95 h-13.75 text-[#FFFFFF] text-sm items-center justify-center rounded-4xl flex flex-row gap-3 rounded-13 max-sm:w-[80%]'><span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button className='text-[#2BBEF9] w-95 h-13.75 bg-[#FFFFFF] text-sm items-center justify-center rounded-4xl flex flex-row gap-3 rounded-13 border-2 max-sm:w-[80%]'><span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex flex-row gap-27 items-center max-sm:gap-16">
            ...
            <div className="flex flex-row gap-5 mt-12 ml-29 max-sm:ml-[22%] max-sm:flex-wrap ">
            ...
            <div className="flex flex-row gap-7  mt-12 ml-29 max-sm:ml-[22%] max-sm:flex-col">
                ...
                <div className="w-214 h-44 flex flex-col max-sm:w-[40%]">
            ...
            <h1 className='mt-12 ml-29 font-bold max-sm:ml-[22%]'>Related Ads</h1>

            <div className='flex flex-row flex-wrap mt-5 mb-2.5 ml-27 max-sm:ml-[14%] '>
                <div className="flex gap-5 py-4 px-2.5 max-sm:gap-2">
                    <div className=" relative flex w-64 h-auto flex-col bg-[#f5f5f5] py-1.25 px-2.5 max-sm:w-[70%]">
                        <img className='w-full h-44 rounded-tl-xl rounded-tr-xl ' src={p3} alt="" />
                        <div className='content py-1.25 px-2.5'>
                            <h3 className=' w-full font-semibold text-sm text-[#141821] leading-5 tracking-normal font-[Poppins] '>iPhone 14 Pro Max 1TB Factory Uncloked</h3>
                            <h4 className=' w-full  font-normal text-[#858997] text-xs leading-6 font-[Poppins] tracking-normal  '>DC Chowk, Rahim Yar Khan</h4>
                            <p className='w-full h-3.5 font-[Poppins] leading-full text-[#000000] leading-none  text-xs tracking-normal max-sm:mb-3'>6 days ago</p>
                ...
                <div className="flex gap-5 py-4 px-2.5 max-sm:gap-2">
                    <div className=" relative flex w-64 h-auto flex-col bg-[#f5f5f5] py-1.25 px-2.5 max-sm:w-[70%]">
                        ...
                        <div className='content py-1.25 px-2.5'>
                            <h3 className=' w-full font-semibold text-sm text-[#141821] leading-5 tracking-normal font-[Poppins] '>iPhone 14 Pro Max 1TB Factory Uncloked</h3>
                            <h4 className=' w-full  font-normal text-[#858997] text-xs leading-4 font-[Poppins] tracking-normal  '>DC Chowk, Rahim Yar Khan</h4>
                            <p className='w-full h-3.5 font-[Poppins] leading-full text-[#000000] leading-none  text-xs tracking-normal max-sm:mb-3'>6 days ago</p>
                            <div className=" flex flex-row items-center justify-between ">
                                <h2 className='w-32 h-5 text-[#000000] leading-5.2 text-lg font-bold'>Rs. 1,80,000</h2>
                                <svg width="20" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
