...
const MsgSentSuccessful = () => {
    return (
        <>
            <div className='flex flex-col mt-37 ml-130 p-5 justify-center items-center w-125 h-92 rounded-2xl  relative'>
                <div className="flex flex-col justify-center items-center w-94">
                    <h1 className='font-[Poppins] font-semibold text-[18px] text-[#000000]'>Message Sent Successfully!</h1>
                    <p className='font-[Poppins] font-normal text-sm text-[#000000] text-center'>Thanks for Reaching out for help at Classified. You are
                ...
                <div className="flex flex-col mt-3">
                    <button className='w-61 h-12 text-[white] bg-[#2BBEF9] flex items-center justify-center rounded-3xl cursor-pointer'>Go to Home</button>
                </div>
