...
const CreateProfile = () => {
    return (
        <>
            <div className='flex flex-col p-5 border-2 mt-20 mx-30 border-[#D8DFE0]'>
                <p className='font-[Poppins] text-[#000000] font-semibold text-sm'>Profile</p>
                ...
                <div className="flex flex-col gap-7 mt-7">
                    <form action="">
                        <div className="flex flex-col gap-3 m-6 relative">
                            <label className='text-[#414141] font-normal text-sm' htmlFor="name">Name</label>
                            <input className='w-116 p-3 border border-[#D0D0D0]' type="text" id="name" placeholder='Wassi Ahsan' />
                        </div>
                        <div className="flex flex-col border-2 border-[#D8DFE0] w-94 h-31 p-4 absolute right-100 bottom-27 ">
...
<p className='font-[Poppins] font-normal text-[10px] leading-6 text-[#333333]'>Classified is built on trust. Help other people get to know you. Tell them about the things you like. Share your favorite brands, books, movies, shows, music, food. And you will see the results…</p>
                        ...
                        <div className="flex flex-col gap-3 m-6">
                            ...
                            <div className="flex flex-row gap-5 ">
                                <select className='border border-[#D0D0D0] w-36 h-12 rounded-sm px-2' name="" id="">
                                    <option value="">DD</option>
                                    <option value="">Tuesday</option>
                                    <option value="">Wednesday</option>
                                </select>
                                <select name="" id="" className='border border-[#D0D0D0] px-2 w-36 h-12 rounded-sm'>
                                    <option value="">MM</option>
                                    <option value="">January</option>
                                    <option value="">Febrary</option>
                                </select>
                                <select className='border border-[#D0D0D0] px-2 w-36 h-12 rounded-sm' name="" id="">
                        ...
                        <div className="flex flex-col gap-3 m-6">
                            ...
                            <select name="" id="" className='w-116 p-3 border border-[#D0D0D0]'>
                        ...
                        <div className="flex flex-col gap-3 m-6 relative">
                            ...
                            <textarea name="" id="" className='w-116 h-33 border border-[#D0D0D0] p-4' placeholder='About me (Optional) '></textarea>
                            <p className='text-[#333333] font-[Poppins] font-normal text-xs absolute top-43 right-162 '>0/200</p>
                        </div>
                        <div className="flex flex-col gap-3 m-10 ">
                            <h1 className='font-[Poppins] font-semibold text-base text-[#000000]'>Contact Information</h1>
                            <label htmlFor="phone" className='text-[#414141] font-normal text-sm w-130 p-3 border border-[#D0D0D0]'>
                                +92 | <input className='border-none' type="text" name="" id="phone" placeholder='Phone Number' />
                            </label>
                            <p className='font-[Poppins] font-normal text-xs leading-3 text-[#333333] text-left ml-19'>This is the number for buyers contacts, reminders, and other notifications.</p>
                            <input className='w-130 p-3 ' type="text" name="" id="" placeholder='name.connect@gmail.com' />
                            <p className='font-[Poppins] font-normal text-xs leading-3 text-[#333333] text-left ml-24'>We won't reveal your email to anyone else nor use it to send you spam</p>
                        ...
                        <div className="flex flex-col gap-3 m-10 ">
                            ...
                            <div className="flex flex-row gap-16">
                                ...
                                <button className='w-35 h-12.5 border-2 rounded-3xl text-[#2BBEF9] font-[Poppins] font-bold text-xs '>Connect</button>
                            </div>
                            <div className="flex flex-row gap-12">
                                ...
                                <button className='w-35 h-12.5 border-2 rounded-3xl text-[#2BBEF9] font-[Poppins] font-bold text-xs '>Disconnect</button>
                            </div>

                        </div>
                        <div className="flex flex-row gap-7 justify-start items-center ml-10">
                            <button className='w-36 h-12.5 text-[white] bg-[#2BBEF9] rounded-3xl text-xs '>Save Changes</button>
                            <button className='w-36 h-12.5 text-[#2BBEF9] border-2 rounded-3xl text-xs '>Discard</button>
...
<div className='flex flex-col p-5 border-2 border-[#D8DFE0] mt-20 mx-30 gap-4'>
    ...
    <button className='w-51 h-12.5 text-[white] bg-[#2BBEF9] rounded-3xl text-xs pl-3'>Yes, delete my account</button>
</div>
        </>
    );
}
