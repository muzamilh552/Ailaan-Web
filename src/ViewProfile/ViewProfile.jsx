...
const ViewProfile = () => {
    return (
        <>
            <div className='flex flex-row justify-evenly mt-20 max-sm:flex-col max-sm:ml-[22%]'>
                <div className="flex flex-col gap-4 max-sm:ml-[20%]">
                    ...
                    <p className='font-[Poppins] font-normal text-sm text-center max-sm:text-start'><span className='text-[#3A77FF]'>Report User</span> | <span className='text-[#3A77FF]'>Block User</span></p>
                </div>
                <div className="flex flex-col gap-6 justify-start items-start max-sm:mt-7">
